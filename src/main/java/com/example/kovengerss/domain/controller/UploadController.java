...
public class UploadController {
    ...
    public List<AttachFileVO> uploadAjax(MultipartFile[] files) throws IOException {
        ...
        String rootDirectory = "C:\\Users\\User\\Desktop\\web_1900_LJW\\spring\\workspace\\kovengerss\\src\\main\\resources\\static\\";
//
...
//
    ...
    public byte[] getFile(String path) throws IOException {
        return FileCopyUtils.copyToByteArray(new File("C:\\Users\\User\\Desktop\\web_1900_LJW\\spring\\workspace\\kovengerss\\src\\main\\resources\\static\\" + path));
    }

    @GetMapping("/download")
    @ResponseBody
    public ResponseEntity<Resource> download(String path) throws UnsupportedEncodingException {
        Resource resource = new FileSystemResource("C:\\Users\\User\\Desktop\\web_1900_LJW\\spring\\workspace\\kovengerss\\src\\main\\resources\\static\\" + path);
...
//        썸네일 삭제
        File file = new File("C:\\Users\\User\\Desktop\\web_1900_LJW\\spring\\workspace\\kovengerss\\src\\main\\resources\\static\\", path);
